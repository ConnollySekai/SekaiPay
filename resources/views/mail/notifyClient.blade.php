  ...
  <div style="background-color:#BFBFBF;">
    ...
    <div style="background:#ffffff;background-color:#ffffff;Margin:0px auto;max-width:600px;">
      ...
      <![endif]-->
                  ...
                  <tr>
                    <td align="left" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                      <div style="font-family:Roboto;font-size:16px;line-height:1.4;text-align:left;color:#6C6C6C;">{!! trans('translations.mail_client_line_2', ['contract_id' => $invoice->contract_id, 'business_email' => $invoice->business_email], $locale) !!}</div>
                    </td>
                  </tr>
                  <tr>
                    <td align="left" style="font-size:0px;padding:10px 25px;word-break:break-word;">
